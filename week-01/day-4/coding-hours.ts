...
var averagetime = (workhourstotal/semesterlength)*100;
var shortnumber = averagetime.toFixed(2);
var percentage = (codingspent/semestercoding)*100;
var percentagecorrect = percentage.toFixed(2);
console.log ("If the average work hours weekly is 52, we spend " + shortnumber + "% of the semester coding.");
console.log ("Additionally, that means that we spend " + percentagecorrect + "% of the working hours coding.");